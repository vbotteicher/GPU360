...
ScanConvertWork2::ScanConvertWork2(GLuint inputTex, GLuint outputTex, const char * vert,const char * frag) : Work(inputTex, outputTex, vert, frag) {}

void ScanConvertWork2::Draw(GLuint framebuffer,GLuint vertexbuffer,GLuint uvbuffer)
{   
