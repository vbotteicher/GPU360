...
Sep3x3LatWork::Sep3x3LatWork(GLuint inputTex, GLuint outputTex, const char * vert,const char * frag, float * kernel3x3) : Work(inputTex, outputTex, vert, frag) {kernel = kernel3x3;}

void Sep3x3LatWork::Draw(GLuint framebuffer,GLuint vertexbuffer,GLuint uvbuffer)
{
