...
BlendImageWorkHD::BlendImageWorkHD(GLuint inputTex, GLuint outputTex, const char * vert,const char * frag,  GLuint edgeMapTex, GLuint LFTex, GLuint uyTex) : Work(inputTex, outputTex, vert, frag) 
{
...
void BlendImageWorkHD::Draw(GLuint framebuffer,GLuint vertexbuffer,GLuint uvbuffer)
{
