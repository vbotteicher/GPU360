...
Sep5x5AxWork::Sep5x5AxWork(GLuint inputTex, GLuint outputTex, const char * vert,const char * frag, float * kernel5x5) : Work(inputTex, outputTex, vert, frag) {kernel = kernel5x5;}

void Sep5x5AxWork::Draw(GLuint framebuffer,GLuint vertexbuffer,GLuint uvbuffer)
{
