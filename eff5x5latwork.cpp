...
Eff5x5LatWork::Eff5x5LatWork(GLuint inputTex, GLuint outputTex, const char * vert,const char * frag, float * kernel5x5) : Work(inputTex, outputTex, vert, frag) {kernel = kernel5x5;}

void Eff5x5LatWork::Draw(GLuint framebuffer,GLuint vertexbuffer,GLuint uvbuffer)
{
